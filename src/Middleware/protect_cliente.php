<?php
/**
 * Middleware de protección para rutas de CLIENTE
 * Solo usuarios con role = 'cliente' pueden acceder
 */
...
if (basename($_SERVER['PHP_SELF']) !== 'protect_cliente.php') {
    protectCliente();
}
